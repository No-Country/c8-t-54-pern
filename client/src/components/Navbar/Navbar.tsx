...
function Navbar() {
  ...
  return (
    <header className="w-full flex flex-col md:flex-row  justify-between  bg-black h-28 sm:p-2 items-center  font-poppins font-semibold text-2xl text-white">
      <h1 className="text-lg md:text-2xl p-2">MOVEment</h1>
      ...
      <div className={`md:flex md:items-center md:pb-0 pb-36 bg-black absolute md:static md:z-auto z-20 left-0 w-full md:w-auto transition-all duration-500 ease-in ${open ? 'top-28 ':'top-[-490px]'}`}>
        {isLogin ? (
